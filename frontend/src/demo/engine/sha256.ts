 ...
 *
 * The mock provider derives every "random" choice from a hash of its inputs, deep inside
 * synchronous helpers, so the asynchronous Web Crypto API does not fit.
 */
